...
def test_get_new_releases_forwards_category_and_enriches_results() -> None:
    ...
    repository.get_tags_for_novel.return_value = [tag_one, tag_two]
    ...
    repository.get_tags_for_novel.assert_called_once_with(novel.id)
...
def test_get_completed_novels_forwards_category_and_enriches_results() -> None:
    ...
    repository.get_tags_for_novel.return_value = [tag]
