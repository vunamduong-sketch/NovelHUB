...
export const api = axios.create({
  baseURL: configuredBaseUrl ? `${configuredBaseUrl}/api/v1` : '/api/v1',
})
...
export function apiErrorMessage(error) {
  ...
  if (Array.isArray(detail)) return detail[0]?.msg || 'Dữ liệu chưa hợp lệ.'
  if (typeof detail === 'string') return detail
  return 'Không thể kết nối tới máy chủ NovelHUB.'
}
